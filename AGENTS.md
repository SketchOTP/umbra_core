...
**Program gate:** UMBRA-D-000 closed via D-000S (`UMBRA_D000S_FOUNDATION_ARCHITECTURE_QUALIFIED`). **UMBRA-D-001 closed** — `UMBRA_D001_INVARIANT_COMPANION_CORE_QUALIFIED`. **UMBRA-D-002 closed** — `UMBRA_D002_SENSORIMOTOR_SELF_MODEL_QUALIFIED` (provisionally qualified pending D-002V). **UMBRA-D-002V** — `UMBRA_D002V_PERFORMANCE_FAIL`; **D-003 blocked** until `UMBRA_D002V_SEAL_VALIDATED`. Architecture: `docs/architecture/`. Evidence: `docs/evidence/d001/`, `docs/evidence/d002/`, `docs/evidence/d002v/`.
