Current authority: UMBRA-AS-002 ACTIVE from exact baseline `1400e11370fc5dd267cb782649c242a06ec56c54`. Parent AS-001 is terminal/accepted as `AS001_CURRENT_ARBITRATION_REPLACEMENT_REQUIRED`. The current completion blocker is ordinary candidate evaluation: pure bounded learned consequence views are feasible, but the scalar-total scorer is not defensible. AS-002 is zero-run, non-production research into one exact bounded distributed-competition replacement contract without hidden/global utility, cross-channel weights, source priority, or planner semantics. Candidate generation, hard authority, CLOSE-02T, CLOSE-02U, CLOSE-02Z, Governance, Embodiment, VerifiedOutcome, and selected-only learning remain protected. Integrated viability and CLOSE-03 remain blocked.
