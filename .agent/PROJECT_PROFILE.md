Current status: UMBRA-AS-003D TERMINAL `AS003D_SUPPORTED_DOMINANCE_STRUCTURALLY_INSUFFICIENT` from exact start `c5a4049bc1915b7919043bf6381d183ae31b7598`. Offline retained-trace attribution reproduced all 76,216 production attempts across 2,647 qualifying AS-003C decisions. Support gaps and candidate-specific applicability are universal, but genuine supported tradeoffs also occur in 2,645 decisions. The universal joint-support/no-worse predicate yields zero eliminations; physiology-only projection yields a relation in 96.826596% of decisions, proving V1’s relation—not merely absent evidence—is structurally mismatched to ordinary conflict topology. CLOSE-02Z was the de facto selector for all 2,647 qualifying choices. V1 is retired as a forward ordinary-selection candidate. No replacement contract, production/test change, organism/diagnostic rerun, retry/reseed, AS-003E, AS-004, or CLOSE-03 is authorized pending Architect authority. Evidence root: `/srv/ATLAS/100_ACTIVE/Projects/UMBRA-CORE/evidence/live-evidence/umbra-as-003d-frontier-saturation-attribution-r1/`.
