Current authority: UMBRA-CLOSE-02AB ACTIVE from `ef4cbfb7389115e5eb2ab855d14435b87798a743` as non-production, zero-organism-run architecture research. It may inspect retained evidence, current source, and bounded action-effect prior art to determine whether a policy-visible support-producer relation can be formed with verified/constitutional provenance and recruited through an existing qualified action-selection semantic. It may not change production behavior, run organisms, add weights/priorities/candidates/authority, or start an implementation successor. CLOSE-02AA remains terminal and accepted; CLOSE-02Z stochastic composition remains protected.
