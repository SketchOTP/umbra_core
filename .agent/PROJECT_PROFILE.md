Current authority: UMBRA-CLOSE-02AA ACTIVE from `d618dc1c2671320d330d44d1d3dcaaa91b1771c1`. CLOSE-02Z is terminal/accepted and candidate-stable stochastic competition is protected. AA is zero-run, non-production architecture research into policy-valid prospective support acquisition and positive preparation using existing candidates, perception/memory/self-model provenance, and verified consequences. Integrated viability remains unqualified. No production change, organism run, rollback, threshold/effect/weight/priority change, planner, V/X revival, H3, D-013/AX, or CLOSE-03 is authorized.
