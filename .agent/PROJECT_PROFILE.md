Current status: UMBRA-AS-003C ACTIVE from `327f747612626e3894192879ce961489e9308d6a`. It is a fresh retained-replay migration and distributed-competition qualification generation, not a retry of terminal AS-003B. Architect has accepted `AS003B_RETAINED_REPLAY_FAIL` and classified its scalar-winner assertion as `RETAINED_REPLAY_MIGRATION_DEFECT`: AS-001/AS-002 replaced ordinary scalar `score_candidate` authority, but the protected no-intent base-authority property remains mandatory. Production source must remain identical to AS-003B freeze `5c2642ac9c1c0be6340d583caf594f5799ecda13` unless static analysis independently proves an AS-002 contract defect before AS-003C freeze. Pre-freeze allows source-proven pure tests and static validators only. No organism execution, broad pytest, known R1, viability population, AS-004, CLOSE-03, retry/reseed, winner hard-coding, weights, source priority, planner, or post-freeze remediation is authorized.
