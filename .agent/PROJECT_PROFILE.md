Current authority: UMBRA-AS-002 TERMINAL with `AS002_DISTRIBUTED_COMPETITION_CONTRACT_SUPPORTED`. A bounded ordinary-action replacement contract now exists: coherent evidence channels participate through supported dominance, `UNKNOWN` preserves first experience, and protected CLOSE-02Z stochasticity resolves only genuine nondominance. The contract removes scalar totals without adding cross-channel weights, voting, source priority, planner semantics, or new authority. Implementation has not begun; `UMBRA-AS-003_DISTRIBUTED_COMPETITION_IMPLEMENTATION_CANDIDATE` is recommendation-only and requires new Architect authority. Integrated viability and CLOSE-03 remain blocked.
