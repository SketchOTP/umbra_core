Current action-selection research boundary: UMBRA-AS-003P-R3 is a prospective observer-parity measurement qualification from `237251fd9e6b859284d45fe6da42a54a5e0d05a3`. Research comparator/harness code may be added, but `umbra_core/**` modal/production behavior is immutable. Exactly one R0/S0 seed `45878900`, horizon `500` control/shadow pair is allowed after a pushed comparator/execution lock; retries/reseeds are `0/0`. Canonical durable evidence is under `/srv/ATLAS/100_ACTIVE/Projects/UMBRA-CORE/evidence/live-evidence/umbra-as-003p-r3-semantic-shadow-pair-r1/`.
