UMBRA-AS-002 is ACTIVE from exact baseline `1400e11370fc5dd267cb782649c242a06ec56c54`. Parent AS-001 is terminal/accepted as `AS001_CURRENT_ARBITRATION_REPLACEMENT_REQUIRED`. AS-002 is zero-run, non-production action-selection replacement-contract research: define coherent evidence channels and pure one-step consequence views, evaluate bounded non-scalar competition families, resolve physiological and non-physiological conflicts without hidden utility or source priority, preserve UNKNOWN/first experience and qualified organism semantics, specify one exact final-selection rule, and return one permitted verdict. Candidate generation, hard safety/admissibility, CLOSE-02T final authority, CLOSE-02U landmark continuity, CLOSE-02Z stochasticity, Governance, Embodiment, VerifiedOutcome, and selected-only learning remain protected. Active packet: `.agent/tasks/active/UMBRA-AS-002/`. Evidence: `/srv/ATLAS/100_ACTIVE/Projects/UMBRA-CORE/evidence/live-evidence/umbra-as-002-distributed-competition-r1/`.
