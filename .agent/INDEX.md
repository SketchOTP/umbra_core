UMBRA-CLOSE-02AB is ACTIVE from exact baseline `ef4cbfb7389115e5eb2ab855d14435b87798a743`. Parent CLOSE-02AA remains terminal/accepted as `CLOSE02AA_SUPPORT_ACQUISITION_PRIMITIVE_MISSING`. Scope is zero-organism-run, non-production architecture research into a bounded, policy-visible support-producer relation and an existing authority-valid recruitment consumer, with priority audit of `uncertainty_reduction`, expected regulatory gain, eligibility, intent, discovery/reacquisition, action-effect provenance, bootstrap, candidate-stable stochastic compatibility, retained causal lineage, and cross-dimension generality. Production changes, organism runs, retries/reseeds, new weights/priorities/candidates/authority, planner/rollout/global utility, V/X revival, H3, D-013/AX, CLOSE-03, and automatic successor work remain prohibited. Active packet: `.agent/tasks/active/UMBRA-CLOSE-02AB/`. Evidence root: `/srv/ATLAS/100_ACTIVE/Projects/UMBRA-CORE/evidence/live-evidence/umbra-close-02ab-support-producer-r1/`.
