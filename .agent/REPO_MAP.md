...
- Task 13 harness (complete, Gates 1–11 evidence): `experiments/d008/run_experiment.py`, `experiments/d008/evidence.py`, `experiments/d008/validate_evidence.py`; results in `docs/evidence/d008/` (no QUALIFIED / no Gate 12 perf — Task 14)
...
- Experiments: `experiments/d008/` — `constrained_profile.py`, diagnostic controllers, hostile renderer, Task 13 `run_experiment.py`/`evidence.py`/`validate_evidence.py`; Task 14 `run_performance.py`/`run_seal.py` still pending
