UMBRA-AS-001 is ACTIVE from exact baseline `c3003e84a734d25c4d87b921775d1c76d19bebda`. The accepted predecessor is terminal `CLOSE02AC_BROADER_ACTION_SELECTION_REPLAN_REQUIRED`, and the local CLOSE-02 support-acquisition/recovery patching lineage is closed. AS-001 is zero-organism-run, non-production project-level architecture research into the complete action-selection authority path, subsystem causal participation, score provenance/commensurability, candidate semantics, current predictive-model capability, pure bounded preselection one-step consequence views, heuristic migration, distributed evaluation, memory/habit/development integration, and at most three architecture candidates. CLOSE-02T authority, CLOSE-02U landmark continuity, CLOSE-02Z candidate-stable stochasticity, Governance, Embodiment, VerifiedOutcome, identity, learned models, memory, habits, development, relationships, temporal continuity, individuality, habitat, body independence, governed perception, and historical evidence remain protected. No production change, organism run, retry/reseed, hidden truth, recursive rollout, planner, global survival/information scalar, source priority, LLM authority, H3, D-013/AX, CLOSE-03, or automatic successor is authorized. Evidence: `/srv/ATLAS/100_ACTIVE/Projects/UMBRA-CORE/evidence/live-evidence/umbra-as-001-learned-consequence-action-selection-r1/`.
