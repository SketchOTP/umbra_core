UMBRA-CLOSE-02AB is ACTIVE from exact baseline `ef4cbfb7389115e5eb2ab855d14435b87798a743`. The accepted parent is terminal `CLOSE02AA_SUPPORT_ACQUISITION_PRIMITIVE_MISSING`: existing positive preparation is available after support is known, but no bounded policy-visible support-producer relation exists, and eligibility alone was behaviorally insufficient in retained fatigue evidence. 02AB is restricted to retained-evidence/source/prior-art architecture research that separates producer representation from recruitment, tests whether an existing selection consumer such as `uncertainty_reduction` can consume exact support-field producer evidence without a new coefficient or authority, audits verified/constitutional provenance and first-experience bootstrap, and returns at most one contract or exact missing primitive. Production changes and organism runs are zero by contract. Candidate-stable CLOSE-02Z stochasticity, CLOSE-02T authority, CLOSE-02U landmark continuity, Governance, Embodiment, VerifiedOutcome, identity, world/self models, and historical evidence remain protected. No retry/reseed, new weight/priority/candidate/authority, planner/rollout/global utility, V/X revival, H3, D-013/AX, CLOSE-03, or automatic successor is authorized. Evidence: `/srv/ATLAS/100_ACTIVE/Projects/UMBRA-CORE/evidence/live-evidence/umbra-close-02ab-support-producer-r1/`.
