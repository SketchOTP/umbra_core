...
`UMBRA-AS-003A_EVIDENCE_INSUFFICIENT` is accepted. `UMBRA-AS-003B` starts from exact master `adeb4cf746a6e6bb4baf7a171017708e707c8001`; current production source is identical to preserved AS-003 candidate `c266318229ae3759f80ac8958ecf63e8a2ab5468`. The old AS-003 7/13 aggregates are permanent but non-interpretable and prohibited as tuning or qualification evidence. Before any organism execution, complete the AS-002 contract/scope/scalar/completeness audits, freeze the explicit pure-test allowlist, make only independently proven bounded contract-preserving corrections, then create exactly one dedicated freeze. Evidence root: `/srv/ATLAS/100_ACTIVE/Projects/UMBRA-CORE/evidence/live-evidence/umbra-as-003b-fresh-distributed-competition-r1/`; active packet: `.agent/tasks/active/UMBRA-AS-003B/`. No known R1, fresh viability population, AS-004, CLOSE-03, retry, reseed, broad pytest, or organism execution is authorized pre-freeze.
