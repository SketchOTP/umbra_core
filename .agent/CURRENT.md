...
No production/test change, organism run, diagnostic rerun, retry, reseed, V1 revival, global score, cross-system weight, source priority, fixed owner hierarchy, arbitrary timeout/hazard/incumbent coefficient, scheduler fairness, planner/RL/active-inference/POMDP/MPC, AS-003H, AS-004, or CLOSE-03 occurred or is authorized. Richman et al. remains reference-only. Evidence root: `/srv/ATLAS/100_ACTIVE/Projects/UMBRA-CORE/evidence/live-evidence/umbra-as-003g-simultaneous-context-control-r1/`; final manifest pending closeout hash publication.
