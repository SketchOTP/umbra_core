UMBRA-AS-002 is ACTIVE from exact baseline `1400e11370fc5dd267cb782649c242a06ec56c54`. Parent AS-001 is terminal/accepted as `AS001_CURRENT_ARBITRATION_REPLACEMENT_REQUIRED`: bounded pure one-step learned consequence views are feasible, but the existing ordinary scorer collapses heterogeneous propositions into an uncalibrated scalar. AS-002 may derive and falsify at most one implementation-ready bounded non-scalar ordinary-competition contract, including evidence channels, consequence-view authority, UNKNOWN/first-experience handling, explicit conflict/final-resolution semantics, heuristic migration, retained-evidence discrimination, and bounded primary-source review. Candidate generation, hard safety/admissibility, CLOSE-02T one-final-action authority, CLOSE-02U landmark continuity, CLOSE-02Z candidate-stable stochasticity, Governance, Embodiment, VerifiedOutcome, identity, physiology, governed perception, learned models, memory, habits, development, relationships, temporal continuity, individuality, habitat, body independence, and historical evidence remain protected. No production change, organism run, retry/reseed, hidden or explicit global utility, cross-channel weights, source priority, recursive prediction, planner/rollout, learning from unexecuted predictions, H3, D-013/AX, CLOSE-03, or automatic successor is authorized. Evidence: `/srv/ATLAS/100_ACTIVE/Projects/UMBRA-CORE/evidence/live-evidence/umbra-as-002-distributed-competition-r1/`.
