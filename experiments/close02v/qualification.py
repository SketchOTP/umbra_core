...
DIRECTIVE = "UMBRA-CLOSE-02V"
EVIDENCE = Path(
    "/srv/ATLAS/100_ACTIVE/Projects/UMBRA-CORE/evidence/live-evidence/"
    "umbra-close-02v-recovery-reacquisition-r1"
)
...
def load_seeds() -> tuple[dict[str, Any], dict[str, Any]]:
    development = json.loads((EVIDENCE / "CLOSE02V_DEVELOPMENT_SEEDS.json").read_text())
    formal = json.loads((EVIDENCE / "CLOSE02V_FORMAL_SEEDS.json").read_text())
