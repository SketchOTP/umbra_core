"""Literal AS-016 lifecycle, boundedness, soak, and five-arm ablation CLI."""
...
from experiments.as016.downstream import VARIANTS, ablation, boundedness, lifecycle, soak
...
def main() -> None:
    ...
    if args.preflight_ledger_tail is not None:
        if args.preflight_ledger_tail < 32:
            raise ValueError("as016_preflight_ledger_tail_below_per_tick_bound")
    ...
    if checkpoint_hash != output_hash:
        raise RuntimeError("AS016_CHECKPOINT_FINAL_HASH_MISMATCH")
