#!/usr/bin/env python3
"""CLOSE-02U gated qualification runner.
...
def load_seeds() -> tuple[dict[str, Any], dict[str, Any]]:
    development = json.loads((EVIDENCE / "CLOSE02U_DEVELOPMENT_SEEDS.json").read_text())
    formal = json.loads((EVIDENCE / "CLOSE02U_FORMAL_SEEDS.json").read_text())
