...
class CampaignSupervisor:
    ...
    def acquire(self, *, reclaim_stale: bool=False, prior_classified: bool=False) -> None:
        ...
        with os.fdopen(fd,"w") as handle: json.dump({"execution_id":self.execution_id,"pid":os.getpid(),"identity":process_identity(os.getpid()),"database":str(self.database_path)},handle,sort_keys=True)
