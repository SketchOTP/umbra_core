#!/usr/bin/env python3
"""AS-003B single-stage diagnostic runner with retained frontier traces.
...
called only after the AS-003B freeze.
"""
...
def frontier_metrics(trace_path: Path) -> dict[str, Any]:
    """Summarize only read-only runtime trace fields needed by AS-003B."""
