...
**Ending commit:** `af0485a797e4966f7d65ee7f7b513d3e1ac179fb`
**Date:** 2026-07-22
...
- Gate 3 organism real-path (embodiment→perception→recognize→tick_once, 20 seeds): H8 distinct+swap = 1.0, H8 false-merge = 0.0, H9 ambiguous-not-split = 1.0
...
- wall-clock: 64.7 s (8 workers)

## Tests

- `pytest tests/test_d006.py`: 79 passed, 1 skipped in 3.68s
