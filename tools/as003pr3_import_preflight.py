#!/usr/bin/env python3
"""Import-only R3 preflight; never calls fixture, harness main, or runtime tick."""
...
def forbidden_create(*args, **kwargs):
    ...
    raise RuntimeError("AS003PR3 import preflight attempted organism creation")


def forbidden_load(*args, **kwargs):
    calls["load_organism"] += 1
    raise RuntimeError("AS003PR3 import preflight attempted organism load")
...
comparator = importlib.import_module("experiments.as003pr3.semantic_comparator")
harness = importlib.import_module("experiments.as003pr3.shadow_diagnostic")

specs = {}
for name in (
    "experiments.close02r.qualification",
    "experiments.as003pr3.semantic_comparator",
    "experiments.as003pr3.shadow_diagnostic",
    "umbra_core",
):
...
result = {
    "schema": "AS003PR3_IMPORT_ONLY_PREFLIGHT_STDOUT_V1",
    ...
    "comparator_module": comparator.__name__,
