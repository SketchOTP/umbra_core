#!/usr/bin/env python3
"""Create-once durable evidence publication for UMBRA-AS-003P-R4."""
...
ROOT = Path(
    ...
    "umbra-as-003p-r4-body-identity-semantics-r1"
)
...
def publish(name: str, data: bytes) -> str:
    ...
    if destination.exists():
        raise FileExistsError(f"AS003P-R4 create-once evidence exists: {destination}")
