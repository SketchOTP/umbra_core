#!/usr/bin/env python3
"""Create-once durable evidence publication for UMBRA-AS-003S."""
...
ROOT = Path(
    ...
    "umbra-as-003s-atomic-body-replacement-r1"
)
...
def publish(name: str, data: bytes) -> str:
    ...
    if destination.exists():
        raise FileExistsError(f"AS003S create-once evidence exists: {destination}")
