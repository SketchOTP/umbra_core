"""Create-once durable evidence publication for UMBRA-AS-015."""
...
ROOT = Path(
    ...
    "umbra-as-015-multi-need-viability-kernel-completion-r1"
)
...
def publish(name: str, value: Any) -> str:
    """Durably create an evidence file exactly once and return its readback hash."""
    target = ROOT / name
