#!/usr/bin/env python3
"""Create-once durable evidence publication for UMBRA-AS-003P-R1.

This protocol utility has no UMBRA imports. It atomically publishes caller-
supplied UTF-8 JSON/text using file fsync, rename, directory fsync, and exact
...
def publish(name: str, data: bytes) -> str:
    ...
    if destination.exists():
        raise FileExistsError(f"AS003P-R1 create-once evidence exists: {destination}")
